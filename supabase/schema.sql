...
('stall_2', '2', 'Pixie Dust', 'Rakhi & Festive Products', 'Sania Alam', 'Forensic science (School of basic and applied science) • 3rd Year', 'Handmade, eco-friendly crochet products including Rakhis, festive flowers, keychains, and mini pouches. Thoughtfully crafted as cute, affordable, and sustainable gifts using reusable/minimal-waste packaging.', 'moon._child_', 'drkhurshid1.alamthaniyaalam@stu.adamasuniversity.ac.in', '6290568932', '/assets/rakhi.jpeg'),
...
('stall_8', '8', 'Thread and Tales', 'Rakhi & Festive Products', 'Tridipa Laskar', 'Management (School Of Business) • 3rd Year', 'We sell Crochet Items, Key chains, Bandana, Rakhi Items and many more', 'https://www.instagram.com/girlinloops?igsi=c2VnbTF1d3U2cmVr', 'tridipa1.laskar@stu.adamasuniversity.ac.in', '9064474574', '/assets/rakhi.jpeg'),
...
('stall_24', '24', 'Chitra Chatter', 'Rakhi & Festive Products', 'Prapti Biswas', 'BSc Forensic Science (SOBAS) • 1st Year', 'Face Painting', '', 'prapti.biswas@stu.adamasuniversity.ac.in', '9051625436', '/assets/rakhi.jpeg'),
...
('stall_26', '26', 'হেঁশেল কথা', 'Homemade Food & Bakery', 'Saptarnab Karmakar', 'Environmental science and sustainability (SOBAS) • 1st Year', 'Homemade food', '', 'saptarnab1.karmakar@stu.adamasuniversity.ac.in', '6289091985', '/assets/hero/hero2.png'),
...
('stall_31', '31', 'Chatpata Adda', 'Homemade Food & Bakery', 'Rajbir Saha', 'Adamas University • Student Team', 'Delicious & mouth-watering chatpata snacks, savory street treats & refreshments.', '', '', '', '/assets/hero/hero2.png'),
('stall_32', '32', 'B.Tech Momowala', 'Homemade Food & Bakery', 'Sampad Ghosh', 'B.Tech • Adamas University', 'Special homemade momos, delicious steamed & fried dumplings served with authentic spicy chutney and special seasoning.', '', '', '', '/assets/hero/hero2.png')
